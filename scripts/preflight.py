"""Preflight for edu-rl-distributional.
...
REQUIRED_CONFIG = {'data': ['parquet_path', 'world_model_checkpoint'], 'distributional': ['n_quantiles', 'kappa', 'risk_measure', 'alpha', 'pareto_quantiles'], 'training': ['total_steps', 'checkpoint_dir']}
...
def main(strict: bool = True) -> int:
    log.info("=== Preflight: edu-rl-distributional ===")
    results = [
        check_env_loaded(),
        check_r2_env(),
        check_r2_bucket(),
